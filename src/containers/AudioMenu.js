      ...
      <div id="audioMenu">
        ...
        <div className="mb-3">
          <audio controls className="w-100">
            ...
            <source src="src/audio/sample.ogg" type="audio/ogg" />
          </audio>
        ...
        <div className="mb-3">
          ...
          <button disabled className="btn btn-outline-primary btn-block btn-sm">Sample - Lorem Ipsum Dolor Sit Amet</button>
        </div>
      </div>
    );
  }
